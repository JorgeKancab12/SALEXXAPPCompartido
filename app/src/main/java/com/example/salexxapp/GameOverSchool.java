...
public class GameOverSchool extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_over_school);
    ...
    public void restart(View view) {
        ...
        Intent intent = new Intent(GameOverSchool.this, gameSchool.class);
