...
public class ConectorsG extends AppCompatActivity {

    private Button _btnPDF;
    String _url = "https://drive.google.com/file/d/1c-I64q7MFCRnHFKuj3enUgcZslzmZtVb/view?usp=sharing";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conectors_g);
