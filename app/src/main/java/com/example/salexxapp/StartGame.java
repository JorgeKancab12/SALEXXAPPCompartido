...
public class StartGame extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        techList.add("Pillow");
        techList.add("Pot");
        techList.add("Refrigerator");
        techList.add("Soap");
        techList.add("Sofa");
        techList.add("Stove");
        techList.add("table");
        techList.add("Teapot");
        techList.add("Curtains");
        techList.add("Toothbrush");
        techList.add("Tv");
        // Put all the technology names with technology image resource ids in map.
        map.put(techList.get(0), R.drawable.bed);
        map.put(techList.get(1), R.drawable.bookcase);
        map.put(techList.get(2), R.drawable.carpet);
        map.put(techList.get(3), R.drawable.chair);
        map.put(techList.get(4), R.drawable.closet);
        map.put(techList.get(5), R.drawable.cup);
        map.put(techList.get(6), R.drawable.glass);
        map.put(techList.get(7), R.drawable.lamp);
        map.put(techList.get(8), R.drawable.pillow);
        map.put(techList.get(9), R.drawable.pot);
        map.put(techList.get(10), R.drawable.refrigerator);
        map.put(techList.get(11), R.drawable.soap);
        map.put(techList.get(12), R.drawable.sofa);
        map.put(techList.get(13), R.drawable.stove);
        map.put(techList.get(14), R.drawable.table);
        map.put(techList.get(15), R.drawable.teapot);
        map.put(techList.get(16), R.drawable.theatre);
        map.put(techList.get(17), R.drawable.toothbrush);
        map.put(techList.get(18), R.drawable.tv);
