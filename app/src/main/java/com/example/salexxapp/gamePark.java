...
public class gamePark extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_park);
        ...
        techList.add("Bench");
        techList.add("Bridges");
        techList.add("Fountain");
        techList.add("Park");
        techList.add("Path");
        techList.add("Picnic");
        techList.add("Playground");
        techList.add("Pond");
        techList.add("Skateboard");
        techList.add("Slide");
        techList.add("Wind");
        techList.add("Bushes");
        techList.add("Grass");
        ...
        map.put(techList.get(0), R.drawable.bench);
        map.put(techList.get(1), R.drawable.bridges);
        map.put(techList.get(2), R.drawable.fountain);
        map.put(techList.get(3), R.drawable.park);
        map.put(techList.get(4), R.drawable.path);
        map.put(techList.get(5), R.drawable.picnic);
        map.put(techList.get(6), R.drawable.playground);
        map.put(techList.get(7), R.drawable.pond);
        map.put(techList.get(8), R.drawable.skateboard);
        map.put(techList.get(9), R.drawable.slide);
        map.put(techList.get(10), R.drawable.wind);
        map.put(techList.get(11), R.drawable.bushes);
        map.put(techList.get(12), R.drawable.grass);
        map.put(techList.get(13), R.drawable.swing);
        map.put(techList.get(14), R.drawable.tree);
        ...
        countDownTimer = new CountDownTimer(millisUntilFinished, 1000) {
            ...
            public void onFinish() {
                ...
                if (index > techList.size() - 1){
                    ...
                    Intent intent = new Intent(gamePark.this, GameOverPark.class);
