...
public class GameOverPark extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_over_park);
    ...
    public void restart(View view) {
        ...
        Intent intent = new Intent(GameOverPark.this, gamePark.class);
