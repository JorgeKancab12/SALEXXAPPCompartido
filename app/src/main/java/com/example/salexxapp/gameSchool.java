...
public class gameSchool extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        techList.add("Backpack");
        techList.add("Binder");
        techList.add("Blackboard");
        techList.add("Book");
        techList.add("Calculator");
        techList.add("Calendar");
        techList.add("Chalks");
        techList.add("Clipboard");
        techList.add("Clip");
        techList.add("Clock");
        techList.add("Pencils");
        techList.add("Compass");
        techList.add("Computer");
        techList.add("Crayons");
        techList.add("Desk");
        techList.add("Eraser");
        techList.add("Globe");
        techList.add("Glue");
        techList.add("Highlight");
        techList.add("Laptop");

        // Put all the technology names with technology image resource ids in map.
        map.put(techList.get(0), R.drawable.backpack);
        map.put(techList.get(1), R.drawable.binder);
        map.put(techList.get(2), R.drawable.blackboard);
        map.put(techList.get(3), R.drawable.book);
        map.put(techList.get(4), R.drawable.calculator);
        map.put(techList.get(5), R.drawable.calendar);
        map.put(techList.get(6), R.drawable.chalks);
        map.put(techList.get(7), R.drawable.clipboard);
        map.put(techList.get(8), R.drawable.clip);
        map.put(techList.get(9), R.drawable.clock);
        map.put(techList.get(10), R.drawable.pencils);
        map.put(techList.get(11), R.drawable.compass);
        map.put(techList.get(12), R.drawable.computer);
        map.put(techList.get(13), R.drawable.crayons);
        map.put(techList.get(14), R.drawable.desk);
        map.put(techList.get(15), R.drawable.eraser);
        map.put(techList.get(16), R.drawable.globe);
        map.put(techList.get(17), R.drawable.glue);
        map.put(techList.get(18), R.drawable.highlight);
        map.put(techList.get(19), R.drawable.laptop);
        ...
        countDownTimer = new CountDownTimer(millisUntilFinished, 1000) {
            ...
            public void onFinish() {
                ...
                if (index > techList.size() - 1){
                    ...
                    Intent intent = new Intent(gameSchool.this, GameOverSchool.class);
    ...
    public void nextQuestion(View view) {
        ...
        if (index > techList.size() - 1){
            ...
            Intent intent = new Intent(gameSchool.this, GameOverPark.class);
            intent.putExtra("points", points);
            startActivity(intent);
            // Finish StartGame Activity
            finish();
...
// Crear un objeto Toast y mostrar el mensaje
...
// Definir el mensaje a mostrar
            CharSequence text = "La respuesta correcta es" + " " + techList.get(index);
